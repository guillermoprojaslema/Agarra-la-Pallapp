...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón y recuperación}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pabellón y recuperación / DIPRECA}\\[6pt]
...
Enfermero titulado con experiencia en procedimientos, bioseguridad e IAAS en APS/SAR, más cursos vigentes de IAAS (80~h) y RCP/DEA. Registro SIS al día; no acredito un año formal en pabellón y recuperación de alta complejidad. Disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} bioseguridad, continuidad del cuidado, atención segura.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, manejo de insumos, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} calidad, protocolos, orden y trabajo interdisciplinario.\\[2pt]
