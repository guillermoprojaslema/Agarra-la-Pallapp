...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Gestión GES / CAEC}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Gestión GES / continuidad asistencial}\\[6pt]
...
Enfermero titulado con experiencia en APS de sector, seguimiento de crónicos y continuidad del cuidado, con registro en RAYEN. Competencia en SIGGES y derivación asistencial. Diplomado de Calidad y Gestión (320~h). SIS al día; disponibilidad inmediata para gestión GES/CAEC en Providencia.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} seguimiento, continuidad, educación al usuario.\\[2pt]
\textbf{Procedimientos:} registro clínico, protocolos, IAAS.\\[2pt]
\textbf{Gestión:} SIGGES, RAYEN, cartera GES, trabajo interdisciplinario.\\[2pt]
