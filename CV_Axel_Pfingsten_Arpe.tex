...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Clínico / turnos rotativos}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Clínico / turnos rotativos}\\[6pt]
...
Enfermero titulado con experiencia en box APS, SAC/SAR y procedimientos (curaciones, medicación, Foley, muestras). Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para turnos rotativos en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box clínico, SAC/SAR, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, turnos rotativos, trabajo en equipo.\\[2pt]
