...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Toma de muestras / Domicilio / UTM}
}
...
Enfermero titulado con experiencia en toma de muestras, antígeno y PCR, tanto en box APS como en domicilio de pacientes postrados. Competente en identificación, registro y bioseguridad. Cursos de IAAS y RCP/DEA vigentes. Registro SIS al día; disponibilidad part-time y movilidad en la RM.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} toma de muestras, atención domiciliaria, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} muestras, antígeno y PCR, medicación, Foley, bioseguridad e IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, trabajo en terreno, disponibilidad part-time.\\[2pt]
