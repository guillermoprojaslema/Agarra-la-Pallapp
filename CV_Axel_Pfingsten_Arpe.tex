...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — IAAS / Bioseguridad}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- IAAS / Bioseguridad}\\[6pt]
...
Enfermero titulado con experiencia en prevención y control de IAAS, bioseguridad y procedimientos clínicos en APS y SAR. Competente en protocolos de calidad, registro y trabajo en equipo. Curso de IAAS (80~h) y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4\textdegree{} turno.
...
\begin{itemize}
  \item Ejecuté atención preventiva en box de APS, aplicando EMPA/EMPAM y normas de bioseguridad.
  \item Evalué pie diabético y realicé curaciones con técnica aséptica y educación al usuario.
  \item Registré información clínica institucional, asegurando trazabilidad y control de calidad.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté curaciones y medicación según protocolos de IAAS, educando a cuidadores.
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos clínicos aplicando bioseguridad e IAAS en cada prestación.
...
\begin{itemize}
  ...
  \item Apliqué protocolos de IAAS y calidad en la práctica clínica cotidiana.
