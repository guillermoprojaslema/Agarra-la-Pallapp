...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Intermedio / UTI / Procedimientos}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Intermedio / UTI / Procedimientos}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS, y atención de mayor complejidad en APS. Competente en curaciones, medicación, registro y trabajo en equipo. Cursos de IAAS y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4\textsuperscript{o} turno en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, procedimientos, continuidad del cuidado, pacientes de mayor complejidad.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, sonda Foley, toma de muestras, bioseguridad e IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, RCP/DEA, trabajo en equipo, 4\textsuperscript{o} turno.
