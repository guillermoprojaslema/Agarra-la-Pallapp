...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Toma de muestras / volante}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Toma de muestras / volante}\\[6pt]
...
Enfermero titulado con experiencia en toma de muestras en terreno (identificación, antígeno y PCR), más procedimientos APS y movilidad en la RM. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad inmediata para ruta volante.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} toma de muestras, atención volante, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} antígeno, PCR, Foley, curaciones, medicación, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, ruta en terreno, coordinación y registro.\\[2pt]
