...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Hospitalización / 4° turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Hospitalización / 4° turno}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito planta de traumatología hospitalaria. Disponibilidad inmediata para 4° turno en Santiago Centro.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, valoración, continuidad del cuidado en turno.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, 4° turno, trabajo en equipo.\\[2pt]
