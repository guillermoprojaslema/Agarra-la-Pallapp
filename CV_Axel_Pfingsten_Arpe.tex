...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Asistencial Providencia}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Asistencial / centro médico Providencia}\\[6pt]
...
Enfermero titulado con experiencia en box APS y procedimientos (curaciones, medicación, Foley, muestras) con protocolos de IAAS. Trabajo coordinado con médicos y TENS. Cursos IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad L--S diurno 40~h en Providencia.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box ambulatorio, APS, protocolos.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, muestras, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, jornada diurna.\\[2pt]
