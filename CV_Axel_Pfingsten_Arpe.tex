...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Médico quirúrgico}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Médico quirúrgico / continuidad hospitalaria}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS, más continuidad clínica de pacientes de mayor complejidad en APS. Cursos IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para área médico quirúrgica en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} continuidad del cuidado, atención segura, mayor complejidad.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, bioseguridad, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, adaptación y trabajo interdisciplinario.\\[2pt]
