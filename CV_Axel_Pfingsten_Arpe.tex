...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón Cirugía / Gestión del Cuidado}
}
...
Enfermero titulado con experiencia en gestión del cuidado, procedimientos e IAAS en APS. Competente en seguridad del paciente, registro y trabajo interdisciplinario. Curso IAAS 80~h y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4	extdegree{} turno diurno.
...
\begin{itemize}
  ...
  \item Registré evolución e intervenciones, asegurando calidad técnica de la atención.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Coordiné el cuidado con el equipo, informando novedades y recursos de la unidad.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos según indicación, con foco en IAAS y registro.
...
\begin{itemize}
  ...
  \item Apliqué protocolos de IAAS y calidad, velando por la seguridad del paciente.
