...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Médico quirúrgico DIPRECA}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Médico quirúrgico / pabellón DIPRECA}\\[6pt]
...
Enfermero titulado con experiencia en SAR, APS y procedimientos, más cursos vigentes de IAAS (80~h) y RCP/DEA. Registro SIS al día; no acredito un año de pabellón de alta complejidad, pero sí continuidad clínica y apego a protocolos. Disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} continuidad del cuidado, atención segura, apoyo clínico.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA, bioseguridad.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, orden documental y trabajo interdisciplinario.\\[2pt]
