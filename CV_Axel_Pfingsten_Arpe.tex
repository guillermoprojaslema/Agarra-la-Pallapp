...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pediatría / MQ / IAAS}
}
...
Enfermero titulado con experiencia en controles de niño sano (2 meses a 9 años), EEDP, TEPSI, NANEAS y clínicas de lactancia en APS, más SAC/SAR. Competente en medicación, registro e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad para 4\textsuperscript{o} turno. No acredito urgencia pediátrica hospitalaria ni PALS.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} niño sano, NANEAS, EEDP/TEPSI, SAC/SAR, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} medicación, curaciones, bioseguridad e IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, 4\textsuperscript{o} turno, trabajo en equipo.\\[2pt]
