...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Urgencias adultos}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Urgencias adultos / reemplazo}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos clínicos e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito planta de urgencia hospitalaria de adultos. Disponibilidad inmediata para reemplazo en Estación Central.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, atención de urgencia, continuidad clínica.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, reemplazo, trabajo interdisciplinario.\\[2pt]
