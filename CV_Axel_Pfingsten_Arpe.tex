...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Cuidados clínicos / Salud mental / 4to turno}
}
...
Enfermero titulado con experiencia en APS, SAC/SAR, medicación, registro clínico y trabajo interdisciplinario. Curso de abordaje integral del TEA (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad para 4\textsuperscript{o} turno. No acredito dos años de experiencia hospitalaria en salud mental.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} continuidad del cuidado, medicación, registro, trabajo interdisciplinario.\\[2pt]
\textbf{Procedimientos:} medicación, bioseguridad e IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, 4\textsuperscript{o} turno, equipo clínico.\\[2pt]
