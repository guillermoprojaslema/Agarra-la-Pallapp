...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Supervisión / continuidad}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Supervisión clínica / continuidad UPC}\\[6pt]
...
Enfermero titulado con experiencia coordinando equipo de sector APS (curaciones, pie diabético y plan de cuidado) y Diplomado de Calidad (320~h). Cursos IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito cargo de supervisor de UPC. Disponibilidad inmediata en Providencia.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} coordinación de equipo, continuidad, APS/SAR.\\[2pt]
