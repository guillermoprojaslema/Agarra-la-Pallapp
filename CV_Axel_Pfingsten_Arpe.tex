...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Hospitalización Médico Quirúrgica}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Hospitalización Médico Quirúrgica}\\[6pt]
...
Enfermero titulado con experiencia en procedimientos, curaciones, dispositivos y continuidad del cuidado en APS, SAR y domicilio. Competente en IAAS, registro y trabajo interdisciplinario. Curso IAAS 80~h y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4\textdegree{} turno.
...
\begin{itemize}
  \item Ejecuté atención en box de APS, aplicando procedimientos y seguimiento clínico.
  \item Evalué pie diabético y realicé curaciones avanzadas, promoviendo adherencia terapéutica.
  \item Registré evolución en sistemas institucionales, asegurando continuidad hospitalaria del cuidado.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Organicé atención de sector en APS, alineando continuidad del cuidado con el equipo.
