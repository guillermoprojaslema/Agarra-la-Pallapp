...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Clínico / centro médico}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Clínico / centro médico}\\[6pt]
...
Enfermero titulado con experiencia en box APS, procedimientos (curaciones, medicación, Foley, toma de muestras) e IAAS. Registro clínico y trabajo con equipo médico-TENS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para centro médico en Huechuraba.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box ambulatorio, protocolos de atención, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, supervisión de procesos clínicos.\\[2pt]
