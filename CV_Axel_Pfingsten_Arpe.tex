...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Coordinación de Estudios Clínicos}
}
...
Enfermero titulado con experiencia en procedimientos, toma de muestras, administración de medicamentos y registro clínico. Competente en coordinación de pacientes, protocolos y trabajo interdisciplinario. Registro SIS al día; disponibilidad presencial en Santiago.
...
\begin{itemize}
  ...
  \item Mantuve el registro clínico actualizado, asegurando trazabilidad de intervenciones.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté medicación y curaciones según protocolo, educando al usuario en adherencia.
  \item Manejé sonda Foley y exámenes en terreno, con registro clínico actualizado.
  \item Coordiné con el equipo interdisciplinario visitas, plazos e informes de seguimiento.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Realicé toma de muestras con identificación y registro, más antígeno y PCR.
