...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Unidad GES / Gestión Clínica}
}
...
Enfermero titulado con experiencia en gestión clínica, SIGGES y registro en APS. Competente en seguimiento de usuarios, plazos de atención y trabajo administrativo-clínico. Diplomado de Calidad y Gestión en Salud. Registro SIS al día; disponibilidad inmediata.
...
\begin{itemize}
  ...
  \item Registré evolución clínica en sistemas, asegurando trazabilidad administrativa.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  \item Coordiné ingreso y seguimiento de programas, resguardando plazos de atención.
  \item Organicé la atención de sector, coordinando intervenciones y registro con el equipo.
...
\begin{itemize}
  ...
  \item Informé al equipo el estado de casos, apoyando la gestión de pacientes.
\end{itemize}
\vspace{6pt}
