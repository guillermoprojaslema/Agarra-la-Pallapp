...
Enfermero titulado con experiencia en procedimientos, curaciones, dispositivos y continuidad del cuidado en APS, SAR y domicilio. Competente en IAAS, registro y trabajo interdisciplinario. Curso IAAS 80~h y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4	extdegree{} turno en Providencia.
...
\begin{itemize}
  ...
  \item Registré evolución clínica, previniendo complicaciones y asegurando continuidad.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Coordiné continuidad del cuidado con el equipo, informando novedades del turno.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  \item Atendí pacientes agudos en SAC y área respiratoria, monitoreando signos vitales.
  \item Ejecuté curaciones, medicación y Foley con protocolos de IAAS y asepsia.
