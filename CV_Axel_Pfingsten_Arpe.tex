...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — MQ / Hospitalización / IAAS}
}
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos (curaciones, medicación, Foley) e IAAS, y en continuidad del cuidado de pacientes de mayor complejidad en APS. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad para 4\textsuperscript{o} turno. No acredito un año de hospitalización MQ.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, continuidad del cuidado, pacientes de mayor complejidad.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, bioseguridad e IAAS, RCP/DEA.\\[2pt]
