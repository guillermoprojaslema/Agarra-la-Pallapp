...
\begin{center}
  ...
  {\large Enfermero Profesional --- Cuidado Integral Domiciliario}\\[6pt]
...
Enfermero titulado con experiencia en atención domiciliaria, gestión de casos y continuidad del cuidado en el hogar. Competente en evaluación integral, curaciones, administración de medicamentos y educación a cuidadores. Orientado a trabajo interdisciplinario y registro clínico oportuno. Registro SIS y disponibilidad para terreno en RM.
...
\begin{itemize}
  \item Evalué integralmente a pacientes postrados en domicilio, coordinando alertas con el equipo de salud.
  \item Ejecuté curaciones y medicación según protocolos, educando a cuidadores en adherencia.
  \item Manejé sonda Foley y exámenes en terreno, con registro clínico actualizado.
  \item Fortalecí continuidad del cuidado mediante informes claros al equipo interdisciplinario.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Realicé toma de muestras con identificación y registro, más test de antígeno y PCR.
...
\begin{itemize}
  \item Brindé atención directa en APS, vacunatorio, unidad de procedimientos y SAR.
  \item Supervisé y ejecuté procedimientos clínicos con trazabilidad y bioseguridad.
  \item Participé en campañas de vacunación COVID-19 y VPH, fortaleciendo cobertura del PNI.
  \item Ejecuté curaciones, administración de medicamentos, manejo de sonda Foley y toma de exámenes.
