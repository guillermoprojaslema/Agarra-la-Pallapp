...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Jefatura trainee / centros médicos}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Jefatura trainee / centros médicos}\\[6pt]
...
Enfermero titulado con experiencia en box APS, coordinación de equipo de sector y Diplomado de Calidad y Gestión (320~h). Procedimientos e IAAS en ambulatorio. SIS al día; no acredito cargo formal de jefe. Disponibilidad inmediata para centros médicos RedSalud en la RM.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box ambulatorio, APS, coordinación de equipo.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, muestras, IAAS.\\[2pt]
