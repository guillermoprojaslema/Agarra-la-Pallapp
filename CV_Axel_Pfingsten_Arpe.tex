...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Prehospitalario / ambulancias}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Prehospitalario / ambulancias y traslados}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos y manejo inicial de pacientes en contextos de urgencia. Cursos IAAS (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad inmediata para turnos rotativos en ambulancias.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} urgencia, traslado seguro, evaluación y monitoreo de pacientes.\\[2pt]
\textbf{Procedimientos:} medicación, curaciones, accesos, control clínico, RCP/DEA.\\[2pt]
\textbf{Gestión:} checklists, inventario, protocolos y trabajo coordinado.\\[2pt]
