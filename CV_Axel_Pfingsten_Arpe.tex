...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Capacitación / Domiciliaria / Calidad}
}
...
Enfermero titulado con experiencia en atención domiciliaria, procedimientos e IAAS, y en educar a cuidadores y equipos de sector en APS. Competente en protocolos de calidad, registro clínico y coordinación interdisciplinaria. Diplomado de Calidad y Gestión en Salud (320~h) e IAAS (80~h). Registro SIS al día; disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} HOSDOM, postrados, educación clínica, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras, bioseguridad e IAAS.\\[2pt]
\textbf{Gestión:} calidad, inducción de equipos, RAYEN, trabajo interdisciplinario.\\[2pt]
