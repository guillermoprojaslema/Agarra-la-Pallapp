...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Coordinación UTM / Toma de Muestras}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Coordinación UTM / Toma de Muestras}\\[6pt]
...
Enfermero titulado con experiencia en toma de muestras, procedimientos ambulatorios y coordinación de flujos clínicos en APS. Competente en identificación y registro de muestras, bioseguridad e IAAS, y orientación al usuario. Cursos de IAAS y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad inmediata para jornada presencial L--S.
...
\begin{itemize}
  \item Ejecuté atención preventiva en box de APS, coordinando flujos y registro de prestaciones.
  \item Evalué, controlé y eduqué a pacientes con pie diabético, promoviendo autocuidado y adherencia.
  \item Registré información clínica en sistemas institucionales, asegurando trazabilidad de muestras y continuidad.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Organicé atención de sector en APS, alineando turnos y flujos con el equipo de salud.
...
\begin{itemize}
  ...
  \item Coordiné flujo de exámenes del servicio, priorizando identificación y cadena de custodia.
...
\begin{itemize}
  \item Apoyé vacunatorio, unidad de procedimientos y toma de muestras ante contingencias.
  \item Ejecuté curaciones, medicación y dispositivos invasivos con foco en bioseguridad.
  \item Apliqué protocolos de IAAS y registro de muestras en la práctica cotidiana.
