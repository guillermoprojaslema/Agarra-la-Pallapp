...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Prevención y Control de IAAS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Prevención y Control de IAAS}\\[6pt]
...
Enfermero titulado con curso de Prevención y Control de IAAS (80~h) y Diplomado de Calidad y Gestión en Salud (320~h). Experiencia aplicando protocolos de bioseguridad en procedimientos, box y SAR. Competente en registro, supervisión de recursos y trabajo en equipo. Disponibilidad para Lo Barnechea / La Dehesa.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{IAAS y calidad:} prevención y control de infecciones, bioseguridad, protocolos, Diplomado de Calidad (320~h).\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras y esterilidad de box en APS/SAR.\\[2pt]
\textbf{Gestión:} supervisión de recursos, registro clínico, RAYEN, trabajo interdisciplinario.
