...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Infanto-juvenil / Salud mental / 4to turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Cuidados infanto-juveniles / 4\textsuperscript{o} turno}\\[6pt]
...
Enfermero titulado con experiencia en APS, SAC/SAR y seguimiento de niños, niñas y adolescentes (controles de niño sano, EEDP, TEPSI y NANEAS). Competente en valoración, medicamentos, registro clínico y trabajo en equipo interdisciplinario. Curso de abordaje integral del TEA (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad inmediata para 4\textsuperscript{o} turno.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, continuidad del cuidado, NANEAS, niño sano, trabajo en equipo.\\[2pt]
\textbf{Procedimientos:} medicación, registro clínico, bioseguridad e IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, 4\textsuperscript{o} turno, coordinación de sector.\\[2pt]
