...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Gestión GES / seguimiento clínico}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Gestión GES / seguimiento clínico}\\[6pt]
...
Enfermero titulado con seguimiento de cartera APS (crónicos, NANEAS, postrados) y registro clínico. Diplomado de Calidad y Gestión en Salud (320~h). SIS al día; no acredito 6 meses de coordinación GES hospitalaria. Disponibilidad inmediata para gestión presencial en Santiago.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} seguimiento de cartera, continuidad asistencial, APS.\\[2pt]
\textbf{Procedimientos:} registro clínico, educación, procedimientos de apoyo.\\[2pt]
\textbf{Gestión:} RAYEN, SIGGES, calidad y gestión en salud.\\[2pt]
