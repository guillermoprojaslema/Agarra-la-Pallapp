...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Atención Domiciliaria / Procedimientos}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Atención Domiciliaria / Procedimientos}\\[6pt]
...
Enfermero titulado con experiencia en atención domiciliaria a pacientes postrados, procedimientos y toma de muestras en terreno. Competente en administración de medicamentos, curaciones avanzadas y registro clínico. RCP/DEA vigente y registro SIS al día. Hepatitis~B completa; disponibilidad inmediata para jornada completa en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica APS:} atención domiciliaria, pacientes postrados, control niño sano, PSCV, EMPA, EMPAM, NANEAS, pie diabético, insulinoterapia.\\[2pt]
\textbf{Procedimientos:} toma de muestras, curaciones avanzadas, sonda Foley, administración de medicamentos e inyectables, vacunas.\\[2pt]
\textbf{Gestión y sistemas:} autonomía en terreno, educación en salud, trabajo interdisciplinario, RAYEN, SIGGES, prevención y control de IAAS.
