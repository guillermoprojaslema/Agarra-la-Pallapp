...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Asistencial / centro médico}
}
...
Enfermero titulado con experiencia en box APS, procedimientos (curaciones, medicación, Foley, toma de muestras) e IAAS. Registro clínico y trabajo con equipo médico-TENS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para centro médico en San Miguel.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box ambulatorio, APS, protocolos de atención.\\[2pt]
