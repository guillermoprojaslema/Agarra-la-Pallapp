...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — UTM volante / part time}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- UTM volante / part time}\\[6pt]
...
Enfermero titulado con experiencia en unidad de procedimientos y toma de muestras (antígeno/PCR), más box APS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad para sábados y domingos en modalidad volante part-time en la RM.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} UTM, procedimientos ambulatorios, atención de fin de semana.\\[2pt]
\textbf{Procedimientos:} toma de muestras, antígeno, PCR, curaciones, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, programación asistencial, trabajo en equipo.\\[2pt]
