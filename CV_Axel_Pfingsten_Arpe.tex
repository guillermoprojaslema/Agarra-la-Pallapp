...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Continuidad del Cuidado / Cuidados Medios}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Residencia / Coordinación del Cuidado}\\[6pt]
...
Enfermero titulado con experiencia en continuidad del cuidado, pacientes complejos y coordinación de equipos en APS. Competente en procedimientos, IAAS y registro. Curso IAAS 80~h y RCP/DEA vigentes. Disponibilidad diurna en Providencia.
...
\begin{itemize}
  \item Ejecuté atención en box de APS, coordinando seguimiento de pacientes complejos.
  \item Evalué pie diabético y realicé curaciones, orientando al equipo de cuidado.
  \item Registré evolución clínica, detectando alertas y resguardando calidad de la atención.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  \item Organicé ingreso y evaluación de NANEAS, ECICEP y postrados con el equipo de salud.
  \item Organicé atención de sector en APS, coordinando intervenciones con el equipo de salud.
...
\begin{itemize}
  ...
  \item Entregué informes claros al equipo, coordinando la continuidad entre turnos y niveles.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Coordiné seguimiento de pacientes complejos, asegurando continuidad del cuidado.
\end{itemize}
\vspace{6pt}
