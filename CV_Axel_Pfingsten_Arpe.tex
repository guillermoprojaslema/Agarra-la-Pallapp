...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón / Procedimientos / IAAS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pabellón / Procedimientos / IAAS}\\[6pt]
...
Enfermero titulado con experiencia en procedimientos, bioseguridad e IAAS, y atención directa en box y SAR. Competente en preparación de recursos, protocolos de calidad y educación al paciente. Cursos de IAAS y RCP/DEA vigentes. Registro SIS al día; disponibilidad para jornada en Vitacura.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Pabellón / procedimientos:} preparación de box, insumos, curaciones, medicación y dispositivos.\\[2pt]
\textbf{Calidad e IAAS:} protocolos de bioseguridad, seguridad del paciente, RCP/DEA, carro de paro.\\[2pt]
\textbf{Equipo:} educación a pacientes, trabajo interdisciplinario, supervisión de recursos, RAYEN.
