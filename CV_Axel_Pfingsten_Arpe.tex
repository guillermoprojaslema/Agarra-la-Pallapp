...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Médico Quirúrgico / Hospitalización}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Médico Quirúrgico / Hospitalización}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS en APS. Competente en curaciones, dispositivos, medicación y registro clínico. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad para 4\textsuperscript{o} turno en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, procedimientos, continuidad del cuidado, seguimiento de crónicos y postrados.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, sonda Foley, toma de muestras, bioseguridad e IAAS.\\[2pt]
\textbf{Gestión y sistemas:} RAYEN, SIGGES, calidad, RCP/DEA, trabajo en equipo hospitalario.
