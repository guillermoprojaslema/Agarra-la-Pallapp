...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — IAAS / Calidad y Gestión}
}
...
Enfermero titulado con Diplomado de Calidad y Gestión en Salud (320~h) y curso IAAS (80~h). Experiencia en bioseguridad, protocolos y coordinación de equipos en APS. Registro SIS al día; disponibilidad inmediata.
...
\begin{itemize}
  ...
  \item Orienté al equipo en curaciones y pie diabético, reforzando prácticas seguras.
...
\begin{itemize}
  ...
  \item Coordiné al equipo de sector, organizando intervenciones y cumplimiento de protocolos.
...
\begin{itemize}
  ...
  \item Resguardé bioseguridad e insumos en procedimientos, con foco en estándares de calidad.
  \item Apliqué protocolos de IAAS, calidad y trazabilidad en procedimientos clínicos.
