...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón / Procedimientos Ambulatorios}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pabellón / Procedimientos Ambulatorios}\\[6pt]
...
Enfermero titulado con experiencia en procedimientos clínicos, bioseguridad e IAAS, y atención ambulatoria en APS y SAR. Competente en curaciones, dispositivos, registro y trabajo en equipo. Cursos de IAAS y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad inmediata para reemplazo diurno.
...
\begin{itemize}
  \item Ejecuté atención preventiva en box de APS, aplicando EMPA/EMPAM y procedimientos de apoyo.
  \item Evalué pie diabético y realicé curaciones, promoviendo autocuidado y adherencia.
  \item Registré información clínica institucional, asegurando trazabilidad y seguridad del paciente.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos clínicos (curaciones, medicación y Foley) con foco en IAAS.
