...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Calidad / gestión de riesgo}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Calidad / gestión de riesgo e IAAS}\\[6pt]
...
Enfermero titulado con Diplomado de Calidad y Gestión en Salud (320~h) y curso de Prevención y Control de IAAS (80~h). Apliqué protocolos de bioseguridad en APS/SAR. SIS al día; disponibilidad inmediata para calidad y gestión de riesgo en Providencia.
...
\textbf{Gestión:} calidad, gestión de riesgo, RAYEN.\\[2pt]
