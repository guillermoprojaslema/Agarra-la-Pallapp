...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Centro médico / toma de muestras}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Centro médico / toma de muestras}\\[6pt]
...
Enfermero titulado con experiencia en box y procedimientos de centro de salud: toma de muestras, curaciones, medicación y Foley. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para reemplazo en centro médico de Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} centro médico, box ambulatorio, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} toma de muestras, exámenes, curaciones, medicación, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, turnos rotativos, trabajo con equipo clínico.\\[2pt]
