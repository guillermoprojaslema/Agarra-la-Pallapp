...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón / IAAS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pabellón / IAAS}\\[6pt]
...
Enfermero titulado con curso de IAAS (80~h) y RCP/DEA vigentes. Experiencia en procedimientos y SAC/SAR. SIS al día; no acredito 2 años de pabellón ni ACLS. Disponibilidad inmediata para jornada diurna en La Dehesa.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} procedimientos, valoración, continuidad clínica.\\[2pt]
\textbf{Procedimientos:} IAAS 80 h, curaciones, medicación, Foley, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, jornada diurna, trabajo en equipo.\\[2pt]
