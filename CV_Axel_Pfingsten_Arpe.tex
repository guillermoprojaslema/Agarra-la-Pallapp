...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pool volante / 4to turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pool volante / 4\textsuperscript{o} turno}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS, y disponibilidad para 4\textsuperscript{o} turno. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito un año de UTI/UCI. Disponibilidad inmediata para pool volante en Providencia.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, continuidad, pacientes de mayor complejidad.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, 4\textsuperscript{o} turno, trabajo en equipo.\\[2pt]
