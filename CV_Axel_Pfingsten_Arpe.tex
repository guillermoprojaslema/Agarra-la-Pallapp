...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Procedimientos / CPA}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Procedimientos ambulatorios / CPA}\\[6pt]
...
Enfermero titulado con experiencia en unidad de procedimientos APS: curaciones, medicación, Foley y toma de muestras, con protocolos de IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito pabellón. Disponibilidad inmediata para CPA en Providencia.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} procedimientos ambulatorios, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, muestras, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, bioseguridad, trabajo en equipo.\\[2pt]
