...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Esterilización / IAAS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Esterilización / bioseguridad}\\[6pt]
...
Enfermero titulado con curso de Prevención y Control de IAAS (80~h) y Diplomado de Calidad y Gestión en Salud (320~h). Apliqué protocolos de bioseguridad en procedimientos APS/SAR. SIS al día; no acredito cargo en central de esterilización. Disponibilidad inmediata para turnos en Estación Central.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} bioseguridad, IAAS, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, protocolos de IAAS.\\[2pt]
\textbf{Gestión:} calidad, RAYEN, trabajo en equipo.\\[2pt]
