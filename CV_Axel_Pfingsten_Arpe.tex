...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Urgencias / part time}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Urgencias / part time}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito planta de urgencia de clínica privada. Disponibilidad para turnos part-time en La Dehesa.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, valoración de urgencia, continuidad clínica.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, part-time, trabajo en equipo.\\[2pt]
