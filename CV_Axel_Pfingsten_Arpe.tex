...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Urgencia / 4to turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Urgencia / 4\textsuperscript{o} turno}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS, y disponibilidad para 4\textsuperscript{o} turno. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito ACLS/PALS ni dos años de urgencia hospitalaria. Disponibilidad inmediata para Maipú.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, valoración oportuna, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA, monitoreo.\\[2pt]
\textbf{Gestión:} RAYEN, 4to turno, trabajo en equipo bajo presión.\\[2pt]
