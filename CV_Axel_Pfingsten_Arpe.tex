...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Gestión GES / Continuidad del Cuidado}
}
...
Enfermero titulado con experiencia en APS, SIGGES y seguimiento de pacientes entre niveles de atención. Competente en derivación, educación al usuario y registro clínico. Diplomado de Calidad y Gestión en Salud. Registro SIS al día; disponibilidad inmediata.
...
\begin{itemize}
  ...
  \item Registré evolución en RAYEN/SIGGES, asegurando trazabilidad del caso.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  \item Coordiné ingreso y seguimiento de NANEAS, ECICEP y postrados, resguardando plazos.
...
\begin{itemize}
  ...
  \item Informé al equipo riesgos de continuidad, apoyando derivaciones oportunas.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Coordiné seguimiento de crónicos y postrados, asegurando continuidad APS-secundaria.
\end{itemize}
\vspace{6pt}
