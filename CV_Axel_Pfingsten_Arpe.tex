...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Navegación / seguimiento}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Navegación / seguimiento clínico}\\[6pt]
...
Enfermero titulado con experiencia en seguimiento de cartera APS: crónicos, NANEAS, ECICEP y postrados, con registro clínico y coordinación de equipo. Manejo de RAYEN y continuidad del cuidado. SIS al día; disponibilidad inmediata para rol de navegador en Vitacura.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} seguimiento, continuidad, educación al paciente.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, registro clínico, IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, coordinación de equipo, cartera.\\[2pt]
