...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Calidad / Centro Médico}
}
...
Enfermero titulado con Diplomado de Calidad y Gestión en Salud (320~h) y curso IAAS (80~h). Experiencia en APS, procedimientos y protocolos de calidad en La Florida. Registro SIS al día; disponibilidad diurna.
...
\begin{itemize}
  \item Ejecuté atención en box de APS, asegurando seguimiento y calidad del proceso.
  \item Evalué pie diabético y realicé curaciones, orientando al equipo de cuidado.
  \item Registré evolución clínica, resguardando trazabilidad y calidad de la atención.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Coordiné al equipo de sector, reforzando cumplimiento de procedimientos institucionales.
...
\begin{itemize}
  ...
  \item Apliqué protocolos de IAAS y calidad, apoyando estándares de acreditación en box.
