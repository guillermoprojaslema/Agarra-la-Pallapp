...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Gestión de camas / continuidad}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Gestión de camas / continuidad asistencial}\\[6pt]
...
Enfermero titulado con experiencia en seguimiento de cartera APS, coordinación de equipo y continuidad del cuidado (crónicos, NANEAS y postrados). Manejo de RAYEN y derivación. Diplomado de Calidad (320~h). SIS al día; disponibilidad inmediata en Estación Central.
...
\textbf{Gestión:} RAYEN, coordinación de flujo, trabajo interdisciplinario.\\[2pt]
