...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Asistencial part-time}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Asistencial part-time / centros médicos}\\[6pt]
...
Enfermero titulado con experiencia en box y procedimientos ambulatorios (curaciones, medicación, muestras) e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS al día; disponibilidad para turnos rotativos L--S en modalidad part-time 18~h.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} box ambulatorio, APS, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, muestras, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, turnos, trabajo en equipo.\\[2pt]
