...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Supervisión esterilización / IAAS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Supervisión de esterilización / IAAS}\\[6pt]
...
Enfermero titulado con curso IAAS (80~h) y Diplomado de Calidad y Gestión en Salud (320~h). Coordiné equipo de sector APS (curaciones y calidad del servicio). SIS al día; no acredito jefatura de central de esterilización. Disponibilidad inmediata en Estación Central.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} bioseguridad, IAAS, coordinación de equipo.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, protocolos de IAAS.\\[2pt]
