...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — APS / MAIS / Gestión del Cuidado}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- APS / MAIS / Gestión del Cuidado}\\[6pt]
...
Enfermero titulado con experiencia en APS, programas ministeriales y trabajo con personas, familias y comunidad. Competente en planes de cuidado, educación en salud y trabajo interdisciplinario en CESFAM. Registro SIS al día. Disponibilidad inmediata para jornada completa en Gran Santiago.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{APS / MAIS:} atención de sector, programas ministeriales, promoción y prevención, NANEAS, ECICEP, EMPA/EMPAM.\\[2pt]
\textbf{Cuidado:} planes de seguimiento, educación en salud, clínicas de lactancia, trabajo con familias y comunidad.\\[2pt]
\textbf{Gestión y sistemas:} trabajo interdisciplinario, RAYEN, SIGGES, capacitación de equipos, continuidad del cuidado.
