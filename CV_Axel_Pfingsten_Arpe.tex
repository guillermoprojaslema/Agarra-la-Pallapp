...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Cardiología / Continuidad Clínica}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Cardiología / Continuidad Clínica}\\[6pt]
...
Enfermero titulado con experiencia en seguimiento cardiovascular (PSCV), ajuste de HTA y continuidad clínica en APS. Competente en insulinoterapia, educación al paciente, registro e IAAS. Cursos de IAAS y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad inmediata para reemplazo.
...
\begin{itemize}
  \item Ejecuté EMPA/EMPAM y controles preventivos, detectando riesgo cardiovascular oportuno.
  \item Evalué pie diabético e insulinoterapia, educando en adherencia y autocuidado.
  \item Registré evolución clínica institucional, asegurando trazabilidad y continuidad del cuidado.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Organicé atención de sector en APS, alineando procedimientos con el equipo de salud.
  ...
  \item Ejecuté EMPA/EMPAM y educación en autocuidado orientada a control cardiovascular.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Apliqué EMPA/EMPAM y eduqué en prevención cardiovascular y autocuidado.
...
\begin{itemize}
  \item Apoyé vacunatorio, unidad de procedimientos y SAR ante contingencias clínicas.
