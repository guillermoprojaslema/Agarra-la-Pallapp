...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Urgencias / SAR / RCP}
}
...
Enfermero titulado con experiencia en SAC/SAR, área respiratoria/COVID-19 y procedimientos de urgencia en APS. Competente en evaluación, medicación, dispositivos y registro oportuno. Cursos de IAAS (80~h) y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, urgencia ambulatoria, continuidad del cuidado, área respiratoria.\\[2pt]
\textbf{Procedimientos:} medicación, curaciones, Foley, bioseguridad e IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, trabajo en equipo, disponibilidad inmediata.\\[2pt]
