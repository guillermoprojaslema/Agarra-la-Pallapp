...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Hospitalización domiciliaria}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Hospitalización domiciliaria / planes de cuidado}\\[6pt]
...
Enfermero titulado con experiencia en hospitalización domiciliaria, curaciones, medicación, Foley y seguimiento clínico en terreno. Trayectoria APS con continuidad del cuidado y trabajo coordinado con TENS y equipo de salud. SIS al día; disponibilidad inmediata para ruta HOSDOM en la RM.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} hospitalización domiciliaria, seguimiento clínico, educación a cuidadores.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, control de signos, toma de muestras.\\[2pt]
\textbf{Gestión:} RAYEN, planes de cuidado, coordinación con TENS y equipo clínico.\\[2pt]
