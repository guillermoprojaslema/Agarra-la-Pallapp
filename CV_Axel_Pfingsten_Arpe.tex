...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — MQ / hospitalización}
}
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos (curaciones, medicación, Foley) e IAAS, y en continuidad de pacientes de mayor complejidad en APS. Cursos IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito un año de hospitalización MQ. Disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, continuidad del cuidado, mayor complejidad.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, bioseguridad, IAAS, RCP.\\[2pt]
