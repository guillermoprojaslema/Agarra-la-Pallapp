...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Gestión poblacional / APS}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Gestión poblacional / seguimiento APS}\\[6pt]
...
Enfermero titulado con experiencia en APS de sector: ingreso, seguimiento y evaluación de crónicos, NANEAS, ECICEP y pacientes postrados. Manejo de RAYEN y continuidad de cartera. Diplomado de Calidad y Gestión en Salud (320~h). Registro SIS al día; disponibilidad inmediata.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} APS de sector, crónicos, NANEAS, postrados.\\[2pt]
\textbf{Procedimientos:} curaciones, insulinoterapia, EMPA/EMPAM, educación.\\[2pt]
\textbf{Gestión:} RAYEN, seguimiento de cartera, trabajo interdisciplinario.\\[2pt]
