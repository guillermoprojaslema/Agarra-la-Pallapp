...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Programación Quirúrgica / Continuidad}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Programación Quirúrgica / Continuidad}\\[6pt]
...
Enfermero titulado con experiencia en coordinación de flujos clínicos, procedimientos y continuidad del cuidado en APS y SAR. Competente en registro, bioseguridad e IAAS, y trabajo interdisciplinario. Cursos de IAAS y RCP/DEA vigentes. Registro SIS y Hepatitis~B al día; disponibilidad inmediata para jornada diurna.
...
\begin{itemize}
  \item Ejecuté atención preventiva en box de APS, coordinando agenda y continuidad de prestaciones.
  \item Evalué, controlé y eduqué a pacientes con pie diabético, promoviendo autocuidado y adherencia.
  \item Registré información clínica institucional, asegurando trazabilidad para la programación del cuidado.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Organicé atención de sector en APS, alineando programación y equipo de salud.
...
\begin{itemize}
  ...
  \item Coordiné flujo de procedimientos y exámenes, priorizando oportunidad y registro.
...
\begin{itemize}
  \item Apoyé vacunatorio, unidad de procedimientos y SAR, coordinando contingencias operativas.
