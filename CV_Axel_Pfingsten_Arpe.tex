...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — UPC adulto / 4° turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- UPC adulto / 4° turno}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito UPC/UCI ni ACLS. Disponibilidad inmediata para 4° turno en La Florida.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, valoración, continuidad clínica.\\[2pt]
\textbf{Procedimientos:} IAAS, RCP/DEA, curaciones, medicación, Foley.\\[2pt]
\textbf{Gestión:} RAYEN, 4° turno, trabajo interdisciplinario.\\[2pt]
