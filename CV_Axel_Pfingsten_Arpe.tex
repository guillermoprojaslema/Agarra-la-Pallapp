...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Clínico honorarios}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Clínico honorarios / urgencia y hospitalización}\\[6pt]
...
Enfermero titulado con experiencia en SAR, APS y procedimientos clínicos (curaciones, medicación, Foley, muestras) con enfoque de calidad e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad inmediata para turnos honorarios en distintas unidades clínicas.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} urgencia, APS, continuidad del cuidado, atención segura.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, adaptabilidad entre unidades, trabajo interdisciplinario.\\[2pt]
