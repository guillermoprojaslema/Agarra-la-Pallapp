...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Procedimientos centro médico}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Asistencial / procedimientos centro médico}\\[6pt]
...
Enfermero titulado con experiencia en procedimientos de enfermería (curaciones, medicación, Foley, toma de muestras) e IAAS en box APS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; disponibilidad L--S diurno para centro médico en Las Condes.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} procedimientos ambulatorios, box, protocolos.\\[2pt]
\textbf{Procedimientos:} curaciones, exámenes, muestras, Foley, IAAS.\\[2pt]
