...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón Volante / Perioperatorio}
}
...
Enfermero titulado con experiencia en procedimientos, IAAS y coordinación clínica en APS y SAR. Competente en registro, bioseguridad y trabajo en equipo. Curso IAAS y RCP/DEA vigentes. Registro SIS al día; disponibilidad para 4	extdegree{} turno modificado.
...
\begin{itemize}
  ...
  \item Informé al equipo el estado de pacientes e intervenciones, asegurando continuidad.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos clínicos con foco en IAAS y seguridad del paciente.
...
\begin{itemize}
  \item Apoyé procedimientos y SAR ante contingencias, con flexibilidad de unidad.
  \item Resguardé bioseguridad e insumos, coordinando recursos con el equipo.
