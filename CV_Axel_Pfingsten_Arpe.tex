...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — IAAS / Calidad}
}
...
Enfermero titulado con curso de Prevención y Control de IAAS (80~h) y Diplomado de Calidad y Gestión en Salud (320~h). Experiencia en bioseguridad y protocolos en APS y SAR. Registro SIS y Hepatitis~B al día; disponibilidad diurna en Lo Barnechea.
...
\begin{itemize}
  ...
  \item Registré prácticas clínicas, apoyando seguimiento de adherencia a protocolos.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté curaciones, medicación y Foley con foco en prevención de infecciones.
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos invasivos resguardando bioseguridad y estándares de calidad.
  \item Apliqué y difundí protocolos de IAAS y calidad en cada procedimiento clínico.
