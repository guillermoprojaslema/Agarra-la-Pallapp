...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Domiciliaria / Procedimientos / IAAS}
}
...
Enfermero titulado con experiencia en atención domiciliaria a pacientes postrados: curaciones, medicación, Foley y toma de muestras en terreno. Competente en seguimiento clínico, educación a cuidadores y registro. Cursos de IAAS y RCP/DEA vigentes. Registro SIS al día; disponibilidad inmediata en Santiago. No acredito ventilación mecánica.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} atención domiciliaria, postrados, continuidad del cuidado, educación a cuidadores.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, toma de muestras, bioseguridad e IAAS.\\[2pt]
\textbf{Gestión:} RAYEN, calidad, SIS, trabajo en equipo.\\[2pt]
