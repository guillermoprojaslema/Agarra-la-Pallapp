...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pabellón / Perioperatorio}
}
...
Enfermero titulado con experiencia en procedimientos, IAAS, registro y coordinación de recursos clínicos. Competente en bioseguridad y trabajo en equipo. Curso IAAS y RCP/DEA vigentes. Registro SIS al día; disponibilidad para 4	extdegree{} turno.
...
\begin{itemize}
  ...
  \item Registré intervenciones y evolución, asegurando trazabilidad del cuidado.
\end{itemize}
\vspace{6pt}
...
\begin{itemize}
  ...
  \item Ejecuté procedimientos (curaciones, medicación y Foley) con protocolos de IAAS.
...
\begin{itemize}
  ...
  \item Resguardé bioseguridad e insumos en procedimientos, con foco en seguridad del paciente.
  \item Apliqué protocolos de IAAS y calidad en cada intervención clínica.
