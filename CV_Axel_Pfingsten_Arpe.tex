...
\hypersetup{
  ...
  pdfsubject={Enfermero Profesional — Pool volante / 4° turno}
}
...
\begin{center}
  ...
  {\large Enfermero Profesional --- Pool volante / 4° turno}\\[6pt]
...
Enfermero titulado con experiencia en SAC/SAR, procedimientos e IAAS. Cursos de IAAS (80~h) y RCP/DEA vigentes. SIS al día; no acredito 3 años en UPC ni ACLS ni diplomado de paciente crítico. Disponibilidad para 4° turno en Estación Central.

%========== COMPETENCIAS ==========
\section{Competencias clave}
\textbf{Clínica:} SAC/SAR, valoración, continuidad del cuidado.\\[2pt]
\textbf{Procedimientos:} curaciones, medicación, Foley, IAAS, RCP/DEA.\\[2pt]
\textbf{Gestión:} RAYEN, 4° turno, rotación entre unidades.\\[2pt]
